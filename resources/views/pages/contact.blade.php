...
<main class="main__content_wrapper">
        ...
        <section class="contact__section section--padding">
            <div class="container">
              ...
              @endif
                        <form class="contact__form--inner" action="{{route('user-contact')}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="input1">Name <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="name" id="input1" placeholder="Enter Your Name" type="text">
                                        @if ($errors->has('name'))
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        <label class="contact__form--label" for="phone">Phone Number <span class="contact__form--label__star">*</span></label>
                                        <input class="contact__form--input" name="phone" id="input2" placeholder="Enter Mobile Number" type="text">
                                        @if ($errors->has('phone'))
                                            <span class="required" style="color:red;">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" name="subject" id="input3" placeholder="subject" type="text">
                        ...
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                {{-- <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white"><a href="tel:+91 7460866023">+91 7460866023</a>   </p>
                                </div> --}}
                            </div>
                        </div>
                        <div class="contact__info--items">
                            ...
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white"> <a href="mailto:Lifecircle1966@gmail.com">Lifecircle1966@gmail.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="contact__info--items">
                            ...
                            <ul class="contact__info--social d-flex">
                                <li class="contact__info--social__list">
                                    <a class="contact__info--social__icon" target="_blank" href="">
        ...
        <div class="contact__map--area section--padding pt-0">
           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d248849.88654024183!2d77.49085236668621!3d12.953959986967877!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBengaluru%2C%20Karnataka!5e0!3m2!1sen!2sin!4v1661236351297!5m2!1sen!2sin" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
