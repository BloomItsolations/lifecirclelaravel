          ...
          <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Refund/Cancelled Policy</h3>
                @if($datas->isEmpty())
                  <a href="{{route('refund-create')}}" class="btn btn-primary float-right">Add</a>
                @endif
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{route('refund-edit', ['id'=>$data->id]) }}" class="btn btn-info">Edit</a>
                              <form id="resource-delete-{{$data->id}}" action="{{route('refund-destroy', ['id'=>$data->id]) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="POST">
                                @csrf
