         ...
         <div class="row">
          <div class="col-md-12">
            <div class="card">
                ...
                @if($datas->isEmpty())
                  <a href="{{route('terms-create')}}" class="btn btn-primary float-right">Add</a>
                @endif
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{route('terms-edit', ['id'=>$data->id]) }}" class="btn btn-info">Edit</a>
                              <form id="resource-delete-{{$data->id}}" action="{{route('terms-destroy', ['id'=>$data->id]) }}" style="display: inline-block;" onSubmit="return confirm('Are you sure you want to delete this item?');" method="POST">
                                @csrf
