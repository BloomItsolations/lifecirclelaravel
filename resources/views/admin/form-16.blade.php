											...
											<table id="example" class="table table-bordered border-t0 key-buttons text-nowrap w-100" >
												...
												<tbody>
													<tr>
														...
														<td><input type="text" class="form-control" placeholder="E-pin No"> </td>
														<td> <input type="file" id="myFile" name="filename"> </th>
														<td> 
															<button type="button" class="btn btn-sm  btn-primary"> Submit </button>
															<a href="{{url('admin/form16view')}}"> <button type="button" class="btn btn-sm  btn-primary">  View </button></a>
														</td> 		
