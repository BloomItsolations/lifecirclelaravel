                ...
                <div class="col-lg-12">
                    <div class="e-panel card">
                        ...
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('add-subcategory') }}">
                                @csrf
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group">
                                                <button id="submit" type="submit" class="btn btn-primary">Create Sub Category</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
