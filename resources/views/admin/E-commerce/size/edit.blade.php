                ...
                <div class="col-lg-12">
                    <div class="e-panel card">
                        ...
                        <div class="card-body">
                            ...
                            <form enctype="multipart/form-data" role="form" id="myform" method="post" action="{{ route('edit-size',$data->id) }}">
                                @csrf
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-12">
                                                ...
                                                @if (count($childCategories))
                                                    <select name="childcategory_id" id="childcategory" class="form-control" required>
                                                        ...
                                                        @foreach ($childCategories as $childCategory)
                                                            <option value="{{ $childCategory->id }}" @if($data->childcategory_id==$childCategory->id )selected @endif>
                                                                {{ $childCategory->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                           ...
                                           @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control" value="{{$data->name}}" placeholder="Enter Size" />
                                                {{-- @if ($errors->has('name'))
                                                    <span class="required">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="short_name" id="short-name" class="form-control" value="{{$data->short_name}}" placeholder="Enter Category Name" />
