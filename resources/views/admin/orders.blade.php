										...
										<div class="card-body">
											<div class="table-responsive text-nowrap">
												<table class="table table-bordered">
													...
													<tbody>
														<tr>
															<td> <img src="assets/img/products/1.jpg"> </td>
															<td> Powder </td>
															<td> 8910563 </td>
															<td> 10 Jul 2022 </td>
															<td> ₹ 89.00 </td>
															<td> In Processing </td>
															<td> <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal1">Update</button> </td>
														</tr>
