...
?>
    ...
    <nav class="navbar navbar-expand-lg main-navbar">
        <a class="header-brand" href="{{route('home')}}">
            <img src="{{ asset('header_front_end/assets/images/logo/logo.png') }}" class="header-brand-img main-logo"
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <li class="dropdown header-user">
                <a href="#" data-toggle="dropdown" class="nav-link  nav-link-lg d-flex">
                    <span><img src="{{asset('storage/user/'.$user->photo)}}" alt="profile-user"
                            class="rounded-circle w-32 mr-2"></span>
                    <span class=" mt-2 d-none d-lg-block ">
                        <span class="text-white-old" style="color: #000;"><span class="ml-1"> User </span></span>
                    </span>
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{route('user-profile')}}"><i class="mdi mdi-account-outline mr-2"></i> <span>My
                            profile</span></a>
                    <a class="dropdown-item" href="{{route('repurchage-cart')}}"><i class="mdi mdi-cart mr-2"></i>
                        <span>Cart</span></a>
                    {{-- <a class="dropdown-item" href="#"><i class="mdi mdi-compass-outline mr-2"></i>
                        <span>Support</span></a> --}}
                    <a class="dropdown-item" href="{{route('user.logout')}}"><i class="mdi  mdi-logout-variant mr-2"></i>
                        <span>Logout</span></a>
                </div>
            </li>
