            ...
            @if ($left_tree)
                @if ($left_tree->left_user_id)
                    <td colspan="2" class="table-primary">
                        <a href="{{ route('child-genealogy', $left_tree->left_user->member_id) }}">
                ...
                @if ($left_tree->middle_user_id)
                    <td colspan="2" class="table-primary">
                        ...
                        <a href="{{ route('child-genealogy', $left_tree->middle_user->member_id) }}">
                            <img class="profile-user-img img-fluid img-circle"
                ...
                @if ($left_tree->right_user_id)
                    <td colspan="2" class="table-primary">
                        ...
                        <a href="{{ route('child-genealogy', $left_tree->right_user->member_id) }}">
                            <img class="profile-user-img img-fluid img-circle"
            ...
            @if ($left_tree)
                ...
                @if ($left_tree->fourth_user_id)
                    <td colspan="1" class="table-primary">
                        ...
                        <a href="{{ route('child-genealogy', $left_tree->fourth_user->member_id) }}">
            ...
            @if ($middle_tree)
                @if ($middle_tree->left_user_id)
                    <td colspan="2" class="table-success">
                        <a href="{{ route('child-genealogy', $middle_tree->left_user->member_id) }}">
                ...
                @if ($middle_tree->middle_user_id)
                    <td colspan="2" class="table-success">
                        ...
                        <a href="{{ route('child-genealogy', $middle_tree->middle_user->member_id) }}">
                ...
                @if ($middle_tree->right_user_id)
                    <td colspan="2" class="table-success">
                        ...
                        <a href="{{ route('child-genealogy', $middle_tree->right_user->member_id) }}">
                            <img class="profile-user-img img-fluid img-circle"
            ...
            @if ($middle_tree)
                ...
                @if ($middle_tree->fourth_user_id)
                    <td colspan="1" class="table-success">
                        ...
                        <a href="{{ route('child-genealogy', $middle_tree->fourth_user->member_id) }}">
            ...
            @if ($right_tree)
                ...
                @if ($right_tree->left_user_id)
                    <td colspan="2" class="table-warning">
                        <a href="{{ route('child-genealogy', $right_tree->left_user->member_id) }}">
                            <img class="profile-user-img img-fluid img-circle"
                ...
                @if ($right_tree->middle_user_id)
                    <td colspan="2" class="table-warning">
                        ...
                        <a href="{{ route('child-genealogy', $right_tree->middle_user->member_id) }}">
                            <img class="profile-user-img img-fluid img-circle"
                ...
                @if ($right_tree->right_user_id)
                    <td colspan="2" class="table-warning">
                        ...
                        <a href="{{ route('child-genealogy', $right_tree->right_user->member_id) }}">
            ...
            @if ($right_tree)
                ...
                @if ($right_tree->fourth_user_id)
                    <td colspan="1" class="table-warning">
                        ...
                        <a href="{{ route('child-genealogy', $right_tree->fourth_user->member_id) }}">
            ...
            @if ($fourth_tree)
                @if ($fourth_tree->left_user_id)
                    <td colspan="2" class="table-info">
                        <a href="{{ route('child-genealogy', $fourth_tree->left_user->member_id) }}">
                            <img class="profile-user-img img-fluid img-circle"
                ...
                @if ($fourth_tree->middle_user_id)
                    <td colspan="2" class="table-info">
                        ...
                        <a href="{{ route('child-genealogy', $fourth_tree->middle_user->member_id) }}">
                            <img class="profile-user-img img-fluid img-circle"
                ...
                @if ($fourth_tree->right_user_id)
                    <td colspan="2" class="table-info">
                        ...
                        <a href="{{ route('child-genealogy', $fourth_tree->right_user->member_id) }}">
            ...
            @if ($fourth_tree)
                ...
                @if ($fourth_tree->fourth_user_id)
                    <td colspan="1" class="table-info">
                        ...
                        <a href="{{ route('child-genealogy', $fourth_tree->fourth_user->member_id) }}">
