...
<html lang="en">
	<head>
		...
		<!--favicon -->
		<link rel="icon" href="{{asset('user/assets/img/brand/favicon.ico') }}" type="image/x-icon"/>
		...
		<link href="{{asset('user/assets/plugins/sidemenu-responsive-tabs/css/sidemenu-responsive-tabs.css') }}" rel="stylesheet">

		<!-- Siderbar css-->
		<link href="{{asset('user/assets/plugins/sidebar/sidebar.css') }}" rel="stylesheet">

		<!-- Color-skins css -->
		<link id="theme" rel="stylesheet" type="text/css" media="all" href="{{asset('user/assets/colors/color-skins/color.css') }}" />
